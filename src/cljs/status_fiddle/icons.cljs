...
(def icons {:icons/discover            (slurp-web-svg "./resources/icons/bottom/discover_gray.svg")
            ...
            :icons/chats               (slurp-web-svg "./resources/icons/chats.svg")
            ...
            :icons/input-commands      (slurp-web-svg "./resources/icons/input_commands.svg")
            :icons/input-send          (slurp-web-svg "./resources/icons/input_send.svg")
            ...
            :icons/up                  (slurp-web-svg "./resources/icons/up.svg")
            :icons/down                (slurp-web-svg "./resources/icons/down.svg")
            ...
            :icons/wnode               (slurp-web-svg "./resources/icons/wnode.svg")
            :icons/refresh             (slurp-web-svg "./resources/icons/refresh.svg")
            :icons/newchat             (slurp-web-svg "./resources/icons/newchat.svg")})
